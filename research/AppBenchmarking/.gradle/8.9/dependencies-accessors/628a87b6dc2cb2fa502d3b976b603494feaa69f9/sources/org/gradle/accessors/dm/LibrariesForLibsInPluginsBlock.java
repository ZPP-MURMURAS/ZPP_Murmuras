...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxBenchmarkLibraryAccessors extends SubDependencyFactory {
        private final AndroidxBenchmarkJunit4LibraryAccessors laccForAndroidxBenchmarkJunit4LibraryAccessors = new AndroidxBenchmarkJunit4LibraryAccessors(owner);

        public AndroidxBenchmarkLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.benchmark.junit4</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxBenchmarkJunit4LibraryAccessors getJunit4() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxBenchmarkJunit4LibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxBenchmarkJunit4LibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public AndroidxBenchmarkJunit4LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>junit4</b> with <b>androidx.benchmark:benchmark-junit4</b> coordinates and
         * with version reference <b>benchmarkJunit4</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        /**
         * Dependency provider for <b>v120</b> with <b>androidx.benchmark:benchmark-junit4</b> coordinates and
         * with version reference <b>benchmarkJunit4Version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getV120() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.benchmark.junit4.v120");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>benchmarkJunit4</b> with value <b>1.3.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBenchmarkJunit4() { return getVersion("benchmarkJunit4"); }

        /**
         * Version alias <b>benchmarkJunit4Version</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBenchmarkJunit4Version() { return getVersion("benchmarkJunit4Version"); }
