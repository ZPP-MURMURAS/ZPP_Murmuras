...
@Composable
fun SimpleMessage(n: Int, modifier: Modifier = Modifier) {
    val memoryWaste = MemoryWaste()
    memoryWaste.wasteMemory(n)
    Text(
        text = "Wasted $n entries in a hashmap",
        modifier = modifier
    )
}
