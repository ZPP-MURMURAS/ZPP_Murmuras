...
from proof_of_concept.bert_training.main import custom_labels
...
def init_finetuner(model_checkpoint):
...
def __align_labels_with_tokens(labels, word_ids, bi_split):
    new_labels = []
    current_word = None
