...
Our first solution was based on the LLaMA architecture and utilized a custom fine-tuned version of LLaMA-3.2-1b provided by Meta\cite{meta-llama}. We have chosen the \emph{meta/llama-3.2-1b} model as the base for the fine-tuning process. Other families of models were considered by us, but they were rejected in favor of the Llamas thanks to either their lack of support in Unsloth and framework provided by Hugging Face or due to the missalignment of the models sizes and performances, like \emph{Gemma 2}\cite{llama-32-intro}.
