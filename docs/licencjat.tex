...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{benchmark/bert_first_vs_concat_recall.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{benchmark/bert_first_vs_concat_precision.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{benchmark/llama_wth_vs_w_recall.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{benchmark/llama_wth_vs_w_precision.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{benchmark/llama_vs_bert_recall.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{benchmark/llama_vs_bert_precision.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{quant_comp/quantization_effect_on_recall.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{quant_comp/quantization_effect_on_precision.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{quant_comp/quantization_effect_on_model_speed.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{quant_comp/quantization_effect_on_gguf_file_size.png}
